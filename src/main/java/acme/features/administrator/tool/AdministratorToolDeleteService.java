...
@Service
public class AdministratorToolDeleteService implements AbstractDeleteService<Administrator, Tool> {
	...
	@Override
	public void delete(final Request<Tool> request, final Tool entity) {
		assert request != null;
		assert entity != null;
